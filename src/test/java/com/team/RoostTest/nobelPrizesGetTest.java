...
public class nobelPrizesGetTest {
    ...
    public void nobelPrizesGet_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "team" + File.separator + "RoostTest" + File.separator + "nobelPrizesGetTest.csv"))) {  
