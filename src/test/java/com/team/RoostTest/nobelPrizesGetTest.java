    ...
    public void nobelPrizes_get_Test() {  
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("src\test\java\com\team\RoostTest\nobelPrizes_get.csv"))) {  
            ...
            if (response.jsonPath().get("nobelPrizes[`"+ i +"`].dateAwarded") != null) {
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("nobelPrizes[`"+ i +"`].dateAwarded"), false); 
            ...
            if (response.jsonPath().get("meta.offset") != null) {
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("meta.offset"), false); 
            ...
            if (response.jsonPath().get("meta.limit") != null) {
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("meta.limit"), false); 
            ...
            if (response.jsonPath().get("meta.nobelPrizeYear") != null) {
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("meta.nobelPrizeYear"), false); 
            ...
            if (response.jsonPath().get("meta.yearTo") != null) {
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("meta.yearTo"), false); 
            ...
            if (response.jsonPath().get("meta.count") != null) {
                ...
                MatcherAssert.assertThat(response.jsonPath().getString("meta.count"), false); 
